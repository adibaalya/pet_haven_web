          ...
          <div class="container table-container">
            <table id="adoptionTable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                $sql = "SELECT p.name, adoption.shelterId, adoption.status, adoption.email, s.name AS shelter_name 
        FROM adoption 
        LEFT JOIN pet p ON adoption.petId = p.id 
        LEFT JOIN shelter s ON adoption.shelterId = s.id";
