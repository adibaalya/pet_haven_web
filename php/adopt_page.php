      ...
      <div class="column card-column">
        ...
        <div class="container-wrapper">
          <div class="container">
            ...
            $pets = [];
            $sql = "SELECT p.id, p.name, p.age, p.breed, p.gender, p.color, p.vaccinated, p.status, p.deworm, p.type, p.image1 as image, s.name as shelter FROM pet p left join shelter s on p.shelterId = s.id ";
            $whereClause = [];
            ...
            if (isset($_GET['shelter']) && $_GET['shelter'] != '') {
              $shelter = $conn->real_escape_string($_GET['shelter']);
            ...
            if (isset($_POST['detail-button'])) {
              ...
              header("Location: detail_animal.php");
              return;
            }
            ?>
            ...
            foreach ($pets as $pet) {
              ...
              echo '<img src="data:image/jpeg;base64,' . htmlspecialchars($pet['image']) . '" alt="Image of ' . htmlspecialchars($pet['name']) . '">';
